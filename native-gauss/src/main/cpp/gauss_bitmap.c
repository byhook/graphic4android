...
#include "gauss_bitmap.h"

#ifdef ANDROID

#include <android/log.h>

#define LOG_TAG    "GaussBitmap"
...
JNIEXPORT jint JNICALL Java_com_onzhou_graphic_GaussBitmap_gaussBitmap
        (JNIEnv *env, jobject jobj, jobject bitmap, jint radius) {
    ...
    if (AndroidBitmap_lockPixels(env, bitmap, (void **) &bitmapData)) {
        ...
        //直接高斯模糊
        GaussBitmap(bitmapData, bmpinfo.width, bmpinfo.height, radius);
