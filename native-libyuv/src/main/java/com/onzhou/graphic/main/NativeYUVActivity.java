 ...
 * @description:
 */
public class NativeYUVActivity extends AbsBaseActivity implements AssertReleaseTask.ReleaseCallback {
    ...
    public void onYUV420PToRGB24(View view) {
        ...
        mNativeYUV.yuv2rgb(file.getAbsolutePath(), NativeYUV.Type.YUV420P_TO_RGB24, 510, 510, mSurfaceView.getHolder().getSurface());
    }

    public void onNV12ToRGB24(View view) {
        File file = new File(getExternalFilesDir(null), "nv12.yuv");
        mNativeYUV.yuv2rgb(file.getAbsolutePath(), NativeYUV.Type.NV12_TO_RGB24, 510, 510, mSurfaceView.getHolder().getSurface());
    }

    public void onNV21ToRGB24(View view) {
        File file = new File(getExternalFilesDir(null), "nv21.yuv");
        mNativeYUV.yuv2rgb(file.getAbsolutePath(), NativeYUV.Type.NV21_TO_RGB24, 510, 510, mSurfaceView.getHolder().getSurface());
    }
